...
Event.create(:name => "Pool Party", :body => "Suntan lotion will be provided", :start_time => Time.now, :end_time => Time.now + 2.days, :neighborhood_id => wwf.id, :user_id => daniel.id, :address => '1500 N Patterson St Valdosta, GA', :image_url => 'pool_party.jpg')
Event.create(:name => "BBQ", :body => "Bring your own beef", :start_time => Time.now + 3.days, :end_time => Time.now + 3.days, :neighborhood_id => wwf.id, :user_id => dwayne.id, :address => '1500 N Patterson St Valdosta, GA', :image_url => 'bbq.jpg')
Event.create(:name => "Salsa Dancing Lessons", :body => "Learn to dance at Maggie's house this week", :start_time => Time.now - 6.days, :end_time => Time.now - 6.days, :neighborhood_id => wwf.id, :user_id => hunter.id, :address => '1500 N Patterson St Valdosta, GA', :image_url => 'salsa.jpg')
Event.create(:name => "Block Party", :body => "Fireworks and music for the whole neighborhood", :start_time => Time.now - 16.days, :end_time => Time.now - 16.days, :neighborhood_id => wwf.id, :user_id => hunter.id, :address => '1500 N Patterson St Valdosta, GA', :image_url => 'block.png')
Event.create(:name => "Battle of the Bands", :body => "Come support your local artists", :start_time => Time.now + 12.days, :end_time => Time.now + 12.days, :neighborhood_id => wwf.id, :user_id => daniel.id, :address => '1500 N Patterson St Valdosta, GA', :image_url => 'bands.png')
