...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { email: @agency.email, name: @agency.name, password: 'secret', password_confirmation: 'secret' }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { email: @agency.email, name: @agency.name, password: 'secret', password_confirmation: 'secret' }
    assert_redirected_to agency_path(assigns(:agency))
  end
