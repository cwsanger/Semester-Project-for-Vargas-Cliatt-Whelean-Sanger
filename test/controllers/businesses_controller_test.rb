...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { email: @business.email, name: @business.name, password: 'secret', password_confirmation: 'secret' }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { email: @business.email, name: @business.name, password: 'secret', password_confirmation: 'secret' }
    assert_redirected_to business_path(assigns(:business))
  end
